  ...
  state: () => ({
    ...
    models: {
      ...
      LA: {
        ...
        ModelType: "BloodTimeVaryingElastance",
        IsEnabled: true,
      ...
      AD_KID: {
        Name: "AD_KID",
        Description: "descending aorta to kidneys",
        ModelType: "BloodResistor",
        IsEnabled: true,
        NoFlow: false,
        NoBackFlow: false,
      ...
      AD_INT: {
        Name: "AD_INT",
        Description: "descending aorta to intestines",
        ModelType: "BloodResistor",
        IsEnabled: true,
        NoFlow: false,
        NoBackFlow: false,
      ...
      KID_IVCE: {
        Name: "KID_IVCE",
        Description: "kidneys to extrathoracic vci",
        ModelType: "BloodResistor",
        IsEnabled: true,
        NoFlow: false,
        NoBackFlow: false,
      ...
      MOUTH: {
        Name: "MOUTH",
        Description: "MOUTHside air",
        ModelType: "GasCompliance",
        IsEnabled: true,
        Vol: 100000000,
        UVol: 100000000,
        ElBase: 0.00076,
      ...
      VENTIN: {
        Name: "VENTIN",
        Description: "inspiration gas reservoir of the mechanical ventilator",
        ModelType: "GasCompliance",
        IsEnabled: false,
        Vol: 5.0,
        UVol: 5.0,
      ...
      TUBINGIN: {
        Name: "TUBINGIN",
        Description:
          "inspiratory limb of the breathing circuit of the mechanical ventilator",
        ModelType: "GasCompliance",
        IsEnabled: false,
        Vol: 0.131,
        UVol: 0.131,
      ...
      TUBINGOUT: {
        Name: "TUBINGOUT",
        Description:
          "expiratory limb of the breathing circuit of the mechanical ventilator",
        ModelType: "GasCompliance",
        IsEnabled: false,
        Vol: 0.131,
        UVol: 0.131,
      ...
      YPIECE: {
        Name: "YPIECE",
        Description:
          "ypiece of the breathing circuit of the mechanical ventilator",
        ModelType: "GasCompliance",
        IsEnabled: false,
        Vol: 0.011,
        UVol: 0.011,
      ...
      VENTOUT: {
        Name: "VENTOUT",
        Description: "expiration gas reservoir of the mechanical ventilator",
        ModelType: "GasCompliance",
        IsEnabled: false,
        Vol: 5.0,
        UVol: 5.0,
      ...
      CHEST_L: {
        Name: "CHEST_L",
        Description:
          "F&P 1.6m, id 10.2mm, volume 0.131 l, compliance 1.3 ml/cmH2O",
        ModelType: "Container",
        IsEnabled: true,
        ContainedModels: ["ALL"],
        Vol: 0.05,
      ...
      CHEST_R: {
        Name: "CHEST_R",
        Description: "pleural space right",
        ModelType: "Container",
        IsEnabled: true,
        ContainedModels: ["ALR"],
        Vol: 0.05,
      ...
      MOUTH_DS: {
        Name: "MOUTH_DS",
        Description: "MOUTHside air to dead space",
        ModelType: "GasResistor",
        IsEnabled: true,
        NoFlow: false,
        NoBackFlow: false,
        CompFrom: "MOUTH",
      ...
      VENTIN_TUBINGIN: {
        Name: "VENTIN_TUBINGIN",
        Description: "inspiratory valve of the mechanical ventilator",
        ModelType: "GasResistor",
        IsEnabled: false,
        NoFlow: false,
        NoBackFlow: true,
      ...
      TUBINGIN_YPIECE: {
        ...
        Description:
          "inspiratory limb of breathing circuit of mechanical ventilator to ypiece",
        ModelType: "GasResistor",
        IsEnabled: false,
        NoFlow: false,
        NoBackFlow: false,
      ...
      YPIECE_DS: {
        Name: "YPIECE_DS",
        Description: "ypiece of mechanical ventilator to patient",
        ModelType: "GasResistor",
        IsEnabled: false,
        NoFlow: true,
        NoBackFlow: false,
      ...
      GASEX_LL: {
        Name: "GASEX_LL",
        Description: "Gas exchanger blood-gas left lung",
        ModelType: "GasExchanger",
        IsEnabled: true,
        CompBlood: "LL",
        CompGas: "ALL",
        DifO2: 0.01,
      ...
      GASEX_LR: {
        Name: "GASEX_LR",
        Description: "Gas exchanger blood-gas right lung",
        ModelType: "GasExchanger",
        IsEnabled: true,
        CompBlood: "RL",
        CompGas: "ALR",
      ...
      Heart: {
        Name: "Heart",
        Description: "heart ecg and activation",
        ModelType: "Heart",
        IsEnabled: true,
        RightAtrium: "RA",
        LeftAtrium: "LA",
        ...
        HeartRate: 120,
        HeartRateRef: 120,
        HeartRateUpperLimit: 300,
        VenticularEscapeRate: 40,
        RhythmType: 0,
        PqTime: 0.1,
        AvDelay: 0.02,
        QrsTime: 0.075,
        QtTime: 0.4,
        CqtTime: 0.19773180231718618,
      },
      Metabolism: {
        Name: "Metabolism",
        Description: "Metabolism model",
        ModelType: "Metabolism",
        IsEnabled: true,
        Vo2: 8.5,
        RespQ: 0.8,
        BodyTemp: 37.0,
      ...
      Breathing: {
        ...
        TidalVolumeSource: "MOUTH_DS",
      },
      AutonomicNervousSystem: {
        Name: "AutonomicNervousSystem",
        Description: "",
        ModelType: "AutonomicNervousSystem",
        IsEnabled: true,
      ...
      Myocardium: {
        Name: "Myocardium",
        Description: "",
        ModelType: "Myocardium",
        IsEnabled: true,
        HeartModelName: "Heart",
        LeftVentricleName: "LV",
        RightVentricleName: "RV",
        CoronariesName: "COR",
        SetTo2: 0.015,
        MinTo2: 0.0,
        MaxTo2: 10.0,
      ...
      MechanicalVentilator: {
        Name: "MechanicalVentilator",
        Description: "",
        ModelType: "MechanicalVentilator",
        IsEnabled: false,
        ...
        FotherDry: 0.0,
        VentInSettings: {
          GasCompliance: ["VENTIN"],
          InternalPressure: 200,
          Volume: 1000000.0,
          Elastance: 1000.0,
        },
        TubingSettings: {
          GasCompliance: ["TUBINGIN", "TUBINGOUT"],
          Length: 1.6,
          InnerDiameter: 0.0102,
          Elastance: 1160.0,
        },
        YPieceSettings: {
          GasCompliance: ["YPIECE"],
          Volume: 0.011,
          Elastance: 25000.0,
        },
        VentOutSettings: {
          GasCompliance: ["VENTOUT"],
          InternalPressure: 4.0,
          Volume: 1000000.0,
          Elastance: 1.0,
          Humidity: 1.0,
          Temp: 37.0,
      ...
      ChestCompressions: {
        Name: "ChestCompressions",
        Description: "",
        ModelType: "ChestCompressions",
        IsEnabled: true,
      },
      Pda: {
        Name: "Pda",
      ...
      ArtificialWhomb: {
        Name: "ArtificialWhomb",
        Description: "",
        ModelType: "ArtificialWhomb",
        IsEnabled: false,
      },
      Drugs: {
        Name: "Drugs",
      ...
      IntrathoracicPressure: {
        Name: "IntrathoracicPressure",
        Description: "",
        ModelType: "IntrathoracicPressure",
        IsEnabled: false,
      },
    },
  }),
